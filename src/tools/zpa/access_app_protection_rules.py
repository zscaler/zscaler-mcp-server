...
def app_protection_policy_manager(
    ...
    name: Annotated[
        str,
        Field(description="Name of the inspection policy rule.")
    ] = None,
    description: Annotated[
        str,
        Field(description="Description of the inspection policy rule.")
    ] = None,
    ...
    rule_order: Annotated[
        str,
        Field(description="Rule order for the inspection policy rule.")
    ] = None,

...
def cloud_applications_manager(
    action: Annotated[
        str,
        Field(description="Action to perform: 'list_apps', 'list_custom_tags', or 'bulk_update'.")
    ],
    page_number: Annotated[
        int,
        Field(description="Optional page number for listing applications.")
    ] = None,
    limit: Annotated[
        int,
        Field(description="Optional result limit for listing applications. Use 1000 as the maximum limit for efficiency.")
    ] = None,
    sanction_state: Annotated[
        str,
        Field(description="One of 'sanctioned', 'unsanctioned', or 'any' for bulk update.")
    ] = None,
    application_ids: Annotated[
        List[str],
        Field(description="List of application IDs to update.")
    ] = None,
    custom_tag_ids: Annotated[
        List[str],
        Field(description="List of custom tag IDs to apply in bulk update.")
    ] = None,

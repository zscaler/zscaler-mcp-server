...
def app_segment_manager(
    ...
    segment_id: Annotated[
        str,
        Field(description="Segment ID for read, update, or delete operations.")
    ] = None,
    ...
    name: Annotated[
        str,
        Field(description="Name of the application segment.")
    ] = None,
    description: Annotated[
        str,
        Field(description="Description of the application segment.")
    ] = None,
    enabled: Annotated[
        bool,
        Field(description="Whether the segment is enabled.")
    ] = True,
    domain_names: Annotated[
        List[str],
        Field(description="List of domain names for the segment.")
    ] = None,
    segment_group_id: Annotated[
        str,
        Field(description="ID of the segment group.")
    ] = None,
    ...
    tcp_port_range: Annotated[
        List[dict],
        Field(description="TCP port ranges in new format.")
    ] = None,
    udp_port_range: Annotated[
        List[dict],
        Field(description="UDP port ranges in new format.")
    ] = None,
    tcp_port_ranges: Annotated[
        List[str],
        Field(description="TCP port ranges in legacy string format.")
    ] = None,
    udp_port_ranges: Annotated[
        List[str],
        Field(description="UDP port ranges in legacy string format.")
    ] = None,
    ...
    health_reporting: Annotated[
        str,
        Field(description="Health reporting configuration.")
    ] = None,
    is_cname_enabled: Annotated[
        bool,
        Field(description="Whether CNAME is enabled.")
    ] = None,
    passive_health_enabled: Annotated[
        bool,
        Field(description="Whether passive health checking is enabled.")
    ] = None,
    clientless_app_ids: Annotated[
        List[dict],
        Field(description="List of clientless app IDs.")
    ] = None,
    search: Annotated[
        str,

...
def zpa_create_app_protection_rule(
    ...
    zpn_inspection_profile_id: Annotated[
        Optional[str],
        Field(description="Inspection profile ID (required if action_type is 'inspect')."),
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Description of the inspection policy rule.")
    ] = None,
    rule_order: Annotated[
        Optional[str], Field(description="Rule order for the inspection policy rule.")
    ] = None,
...
def zpa_update_app_protection_rule(
    ...
    zpn_inspection_profile_id: Annotated[
        Optional[str], Field(description="Inspection profile ID.")
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Description of the inspection policy rule.")
    ] = None,

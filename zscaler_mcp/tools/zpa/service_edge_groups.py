...
def zpa_list_service_edge_groups(
    ...
    query_params: Annotated[
        Optional[Dict],
        Field(description="Optional query parameters for filtering, searching, or pagination."),
    ] = None,
...
def zpa_create_service_edge_group(
    ...
    description: Annotated[
        Optional[str], Field(description="Description of the service edge group.")
    ] = None,
    ...
    version_profile_name: Annotated[
        Optional[str], Field(description="Version profile name.")
    ] = None,
    version_profile_id: Annotated[Optional[str], Field(description="Version profile ID.")] = None,
    service_edge_ids: Annotated[
        Optional[List[str]], Field(description="List of service edge IDs.")
    ] = None,
    trusted_network_ids: Annotated[
        Optional[List[str]], Field(description="List of trusted network IDs.")
    ] = None,
    grace_distance_enabled: Annotated[
        Optional[bool], Field(description="Whether grace distance is enabled.")
    ] = None,
    grace_distance_value: Annotated[
        Optional[int], Field(description="Grace distance value.")
    ] = None,
    grace_distance_value_unit: Annotated[
        Optional[str], Field(description="Grace distance value unit.")
    ] = None,
...
def zpa_delete_service_edge_group(
    ...
    confirmation_check = check_confirmation("zpa_delete_service_edge_group", confirmed, {"group_id": str(group_id)})

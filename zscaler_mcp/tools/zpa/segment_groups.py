...
def segment_group_v6_manager(
    ...
    description: Annotated[
        str, Field(description="Description of the segment group.")
    ] = None,
    ...
    search: Annotated[str, Field(description="Search term for listing groups.")] = None,
    page: Annotated[str, Field(description="Page number for pagination.")] = None,
    page_size: Annotated[
        str, Field(description="Items per page for pagination.")
    ] = None,

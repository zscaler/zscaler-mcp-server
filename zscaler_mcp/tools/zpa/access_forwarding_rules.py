...
def forwarding_policy_manager(
    ...
    name: Annotated[
        str, Field(description="Name of the forwarding policy rule.")
    ] = None,
    description: Annotated[
        str, Field(description="Description of the forwarding policy rule.")
    ] = None,
    ...
    if action == "create":
        ...
        if not rule_id:
            raise ValueError(
                "'rule_id' is required for updating a client forwarding rule"
            )

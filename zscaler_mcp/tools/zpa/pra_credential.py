...
def pra_credential_manager(
    ...
    credential_id: Annotated[
        str, Field(description="Credential ID for read, update, or delete operations.")
    ] = None,
    name: Annotated[str, Field(description="Name of the PRA credential.")] = None,
    description: Annotated[
        str, Field(description="Description of the PRA credential.")
    ] = None,
    credential_type: Annotated[
        str,
        Field(
            description="Type of credential: 'USERNAME_PASSWORD', 'PASSWORD', or 'SSH_KEY'."
        ),
    ] = None,
    user_domain: Annotated[
        str, Field(description="User domain for the credential.")
    ] = None,
    username: Annotated[
        str, Field(description="Username for USERNAME_PASSWORD or SSH_KEY credentials.")
    ] = None,
    password: Annotated[
        str,
    ...
    private_key: Annotated[
        str, Field(description="Private key for SSH_KEY credentials.")
    ] = None,
    ...
    if action == "create":
        if not name or not credential_type:
            raise ValueError(
                "Both 'name' and 'credential_type' are required for creation"
            )
        ...
        if credential_id:
            result, _, err = api.get_credential(

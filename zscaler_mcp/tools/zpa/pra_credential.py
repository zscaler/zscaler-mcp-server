...
def zpa_create_pra_credential(
    ...
    credential_type: Annotated[
        str, Field(description="Type of credential: 'USERNAME_PASSWORD', 'PASSWORD', or 'SSH_KEY'.")
    ],
    username: Annotated[
        Optional[str], Field(description="Username for USERNAME_PASSWORD or SSH_KEY credentials.")
    ] = None,
    password: Annotated[
        Optional[str], Field(description="Password for USERNAME_PASSWORD or PASSWORD credentials.")
    ] = None,
    private_key: Annotated[
        Optional[str], Field(description="Private key for SSH_KEY credentials.")
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Description of the PRA credential.")
    ] = None,
    user_domain: Annotated[
        Optional[str], Field(description="User domain for the credential.")
    ] = None,
    microtenant_id: Annotated[
        Optional[str], Field(description="Microtenant ID for scoping.")
    ] = None,
...
def zpa_delete_pra_credential(
    ...
    confirmation_check = check_confirmation("zpa_delete_pra_credential", confirmed, {"credential_id": str(credential_id)})

...
def zpa_list_application_servers(
    ...
    results = [s.as_dict() for s in servers]
...
def zpa_create_application_server(
    ...
    description: Annotated[
        Optional[str], Field(description="Description of the application server.")
    ] = None,
...
def zpa_update_application_server(
    ...
    address: Annotated[
        Optional[str], Field(description="The domain or IP address of the server.")
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Description of the application server.")
    ] = None,
...
def zpa_delete_application_server(
    ...
    confirmation_check = check_confirmation("zpa_delete_application_server", confirmed, {"server_id": str(server_id)})

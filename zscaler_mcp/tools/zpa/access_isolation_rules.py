...
def isolation_policy_manager(
    ...
    name: Annotated[
        str, Field(description="Name of the isolation policy rule.")
    ] = None,
    description: Annotated[
        str, Field(description="Description of the isolation policy rule.")
    ] = None,
    ...
    zpn_isolation_profile_id: Annotated[
        str,
        Field(
            description="Isolation profile ID (required if action_type is 'isolate')."
        ),
    ] = None,
    ...
    rule_order: Annotated[
        str, Field(description="Rule order for the isolation policy rule.")
    ] = None,
    ...
    if action == "create":
        if not name or not action_type:
            raise ValueError(
                "'name' and 'action_type' are required for creating an isolation rule"
            )

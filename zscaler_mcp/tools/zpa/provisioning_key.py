...
def zpa_create_provisioning_key(
    ...
    component_id: Annotated[
        str, Field(description="Component ID (App Connector Group or Service Edge Group).")
    ],
    ...
    description: Annotated[
        Optional[str], Field(description="Description of the provisioning key.")
    ] = None,
    microtenant_id: Annotated[
        Optional[str], Field(description="Microtenant ID for scoping.")
    ] = None,
...
def zpa_update_provisioning_key(
    ...
    max_usage: Annotated[
        Optional[int], Field(description="Maximum usage count for the provisioning key.")
    ] = None,
    component_id: Annotated[
        Optional[str],
    ...
    enrollment_cert_id: Annotated[
        Optional[str], Field(description="Enrollment certificate ID.")
    ] = None,
    microtenant_id: Annotated[
        Optional[str], Field(description="Microtenant ID for scoping.")
    ] = None,

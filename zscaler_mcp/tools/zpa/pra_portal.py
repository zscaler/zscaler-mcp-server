...
def zpa_create_pra_portal(
    ...
    certificate_id: Annotated[
        Optional[str],
        Field(description="Certificate ID (will auto-resolve from name if not provided)."),
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Description of the PRA portal.")
    ] = None,
    enabled: Annotated[bool, Field(description="Whether the portal is enabled.")] = True,
    user_notification: Annotated[
        Optional[str], Field(description="User notification message for the portal.")
    ] = None,
    user_notification_enabled: Annotated[
        Optional[bool], Field(description="Whether user notifications are enabled.")
    ] = None,
    microtenant_id: Annotated[
        Optional[str], Field(description="Microtenant ID for scoping.")
    ] = None,
    ...
    if not certificate_id:
        ...
        if not certs:
            raise ValueError(
                f"No certificate found matching name: {name}. Please provide certificate_id explicitly."
            )

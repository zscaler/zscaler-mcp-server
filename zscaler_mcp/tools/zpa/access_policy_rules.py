...
def zpa_create_access_policy_rule(
    ...
    description: Annotated[
        Optional[str], Field(description="Description of the access policy rule.")
    ] = None,
    app_connector_group_ids: Annotated[
        Optional[List[str]], Field(description="List of app connector group IDs.")
    ] = None,
    app_server_group_ids: Annotated[
        Optional[List[str]], Field(description="List of app server group IDs.")
    ] = None,
    conditions: Annotated[
        Optional[Any], Field(description="Conditions for the policy rule in v2 format.")
    ] = None,
    microtenant_id: Annotated[
        Optional[str], Field(description="Microtenant ID for scoping.")
    ] = None,
...
def zpa_delete_access_policy_rule(
    ...
    confirmation_check = check_confirmation("zpa_delete_access_policy_rule", confirmed, {"rule_id": str(rule_id)})

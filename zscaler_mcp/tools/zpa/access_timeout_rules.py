...
def zpa_create_timeout_policy_rule(
    ...
    description: Annotated[
        Optional[str], Field(description="Description of the timeout policy rule.")
    ] = None,
    custom_msg: Annotated[
        Optional[str], Field(description="Custom message for the timeout policy rule.")
    ] = None,
...
def zpa_update_timeout_policy_rule(
    ...
    reauth_timeout: Annotated[
        Optional[str], Field(description="Re-authentication timeout value.")
    ] = None,
    reauth_idle_timeout: Annotated[
        Optional[str], Field(description="Re-authentication idle timeout value.")
    ] = None,
    conditions: Annotated[
        Optional[List], Field(description="Conditions for the policy rule.")
    ] = None,
...
def zpa_delete_timeout_policy_rule(
    ...
    confirmation_check = check_confirmation("zpa_delete_timeout_policy_rule", confirmed, {"rule_id": str(rule_id)})

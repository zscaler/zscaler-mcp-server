...
def zia_create_static_ip(
    ...
    comment: Annotated[
        Optional[str], Field(description="Optional comment for the static IP.")
    ] = None,
    geo_override: Annotated[
        Optional[bool], Field(description="Whether to override geolocation.")
    ] = None,
    routable_ip: Annotated[Optional[bool], Field(description="Whether the IP is routable.")] = None,
    latitude: Annotated[
        Optional[float], Field(description="Latitude for geolocation override.")
    ] = None,
    longitude: Annotated[

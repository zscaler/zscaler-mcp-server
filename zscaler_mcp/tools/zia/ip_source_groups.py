...
def zia_ip_source_group_manager(
    ...
    name: Annotated[
        Optional[str], Field(description="Group name (required for add/update).")
    ] = None,
    description: Annotated[
        Optional[str], Field(description="Group description (optional for add/update).")
    ] = None,
    ip_addresses: Annotated[
        Optional[Union[List[str], str]],
        Field(
            description="List of IP addresses (required for add/update). Accepts JSON string or list."
        ),
    ] = None,
    search: Annotated[
        Optional[str],
    ...
    if action == "list":
        ...
        if not group_id or not name or not ip_addresses:
            raise ValueError(
                "group_id, name, and ip_addresses are required for update."
            )

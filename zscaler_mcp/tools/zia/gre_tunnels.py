...
def zia_create_gre_tunnel(
    static_ip_address: Annotated[
        str, Field(description="Static IP address to associate or create (required).")
    ],
    ...
    internal_ip_range: Annotated[
        Optional[str], Field(description="Internal IP range for the GRE tunnel.")
    ] = None,
    comment: Annotated[
...
def zia_delete_gre_tunnel(
    ...
    confirmation_check = check_confirmation("zia_delete_gre_tunnel", confirmed, {"tunnel_id": str(tunnel_id)})

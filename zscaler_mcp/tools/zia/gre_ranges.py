...
def gre_range_discovery_manager(
    internal_ip_range: Annotated[
        str, Field(description="CIDR range (e.g., '172.17.47.247-172.17.47.240')")
    ] = None,
    static_ip: Annotated[
        str, Field(description="Filter by the associated static IP address")
    ] = None,
    limit: Annotated[int, Field(description="Max number of ranges to return")] = None,
    ...
    ranges, _, err = gre_api.list_gre_ranges(

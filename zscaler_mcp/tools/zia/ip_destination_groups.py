...
def zia_update_ip_destination_group(
    ...
    description: Annotated[Optional[str], Field(description="Description of the group.")] = None,
    addresses: Annotated[
        Optional[Union[List[str], str]], Field(description="List of IPs/FQDNs.")
    ] = None,
    countries: Annotated[
        Optional[Union[List[str], str]], Field(description="List of country codes.")
    ] = None,
    ip_categories: Annotated[
...
def zia_delete_ip_destination_group(
    ...
    confirmation_check = check_confirmation("zia_delete_ip_destination_group", confirmed, {"group_id": str(group_id)})

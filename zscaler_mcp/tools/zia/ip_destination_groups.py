...
def zia_ip_destination_group_manager(
    ...
    type: Annotated[
        Optional[str],
        Field(
            description="Group type (DSTN_IP, DSTN_FQDN, DSTN_DOMAIN, DSTN_OTHER). Required for add/update."
        ),
    ] = None,
    addresses: Annotated[
        Optional[Union[List[str], str]],
        Field(
            description="List of IPs/FQDNs. Required for add/update if type is DSTN_IP or DSTN_FQDN."
        ),
    ] = None,
    countries: Annotated[
        Optional[Union[List[str], str]],
        Field(
            description="List of country codes (e.g., COUNTRY_CA). Optional for DSTN_OTHER."
        ),
    ] = None,
    ip_categories: Annotated[
        Optional[Union[List[str], str]],
        Field(
            description="List of URL categories (e.g., CUSTOM_01). Optional for DSTN_OTHER."
        ),
    ] = None,

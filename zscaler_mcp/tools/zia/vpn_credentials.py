...
def zia_list_vpn_credentials(
    ...
    results = [c.as_dict() for c in credentials]
...
def zia_create_vpn_credential(
    credential_type: Annotated[
        str, Field(description="Type of credential: 'IP' or 'UFQDN' (required).")
    ],
    pre_shared_key: Annotated[str, Field(description="Pre-shared key (required).")],
    ip_address: Annotated[
        Optional[str], Field(description="IP address (required for type 'IP').")
    ] = None,

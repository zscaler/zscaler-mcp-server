...
def zins_get_cyber_incidents(
    ...
    Examples:
        ...
        >>> incidents = zins_get_cyber_incidents(
        ...     start_days_ago=14,
        ...     end_days_ago=2,
...
def zins_get_cyber_incidents_by_location(
    ...
    Examples:
        ...
        >>> incidents = zins_get_cyber_incidents_by_location(
        ...     start_days_ago=14,
        ...     end_days_ago=2,
...
def zins_get_cyber_incidents_daily(
    start_days_ago: Annotated[
        int,
        Field(
    ...
    Examples:
        ...
        >>> daily = zins_get_cyber_incidents_daily(
        ...     start_days_ago=30,
        ...     end_days_ago=2,
        ...     limit=30
        ... )
...
def zins_get_cyber_incidents_by_threat_and_app(
    ...
    Examples:
        ...
        >>> incidents = zins_get_cyber_incidents_by_threat_and_app(
        ...     start_days_ago=14,
        ...     end_days_ago=2,
        ...     limit=20
        ... )

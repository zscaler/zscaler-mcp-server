...
from zscaler_mcp.tools.zins.common import (
...
def zins_get_web_traffic_by_location(
    ...
    Examples:
        ...
        >>> locations = zins_get_web_traffic_by_location(
...
def zins_get_web_traffic_no_grouping(
    start_days_ago: Annotated[
        int,
        Field(
    ...
    Examples:
        >>> traffic = zins_get_web_traffic_no_grouping(
...
def zins_get_web_protocols(
    ...
    Examples:
        >>> protocols = zins_get_web_protocols(start_days_ago=7, end_days_ago=2)
    """
    # Resolve time parameters
    resolved_start, resolved_end = resolve_time_params(
        start_time, end_time, start_days_ago, end_days_ago
...
def zins_get_threat_super_categories(
    start_days_ago: Annotated[
        int,
        Field(
            description="Days ago for start. Default: 9 (7-day interval). API needs 7 or 14 day intervals."
    ...
    Examples:
        >>> threats = zins_get_threat_super_categories(start_days_ago=7, end_days_ago=2)
    """
    # Resolve time parameters
    resolved_start, resolved_end = resolve_time_params(
        start_time, end_time, start_days_ago, end_days_ago
...
def zins_get_threat_class(
    ...
    Examples:
        >>> threat_classes = zins_get_threat_class(start_days_ago=7, end_days_ago=2)
    """
    # Resolve time parameters
    resolved_start, resolved_end = resolve_time_params(
        start_time, end_time, start_days_ago, end_days_ago

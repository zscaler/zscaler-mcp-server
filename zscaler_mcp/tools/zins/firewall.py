...
def zins_get_firewall_by_action(
    ...
    Examples:
        ...
        >>> actions = zins_get_firewall_by_action(
        ...     start_days_ago=7,
        ...     end_days_ago=2,
        ...     limit=10
        ... )
...
def zins_get_firewall_by_location(
    start_days_ago: Annotated[
        int,
        Field(
            description="Days ago for start. Default: 9 (7-day interval). API needs 7 or 14 day intervals."
    ...
    Examples:
        ...
        >>> locations = zins_get_firewall_by_location(
        ...     start_days_ago=7,
        ...     end_days_ago=2,
        ...     limit=20
        ... )
...
def zins_get_firewall_network_services(
    start_days_ago: Annotated[
        int,
        Field(
            description="Days ago for start. Default: 9 (7-day interval). API needs 7 or 14 day intervals."
    ...
    Examples:
        ...
        >>> services = zins_get_firewall_network_services(
        ...     start_days_ago=7,
        ...     end_days_ago=2,
        ...     limit=30
        ... )

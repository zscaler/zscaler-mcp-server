...
class TestWebTrafficTools:
    ...
    def test_invalid_traffic_unit_raises_error(self):
        ...
        from zscaler_mcp.tools.zins.web_traffic import (
    ...
    @patch("zscaler_mcp.tools.zins.web_traffic.get_zscaler_client")
    def test_get_web_traffic_by_location_success(self, mock_get_client):
        ...
        mock_client.zins.web_traffic.get_traffic_by_location.return_value = (
            [mock_entry],
            None,
            None,
        )
        ...
        # Execute
        result = zins_get_web_traffic_by_location(
            start_time=1702600000000,
            end_time=1702686400000,
            traffic_unit="TRANSACTIONS",
            limit=10,
    ...
    def test_get_web_protocols_success(self, mock_get_client):
        ...
        from zscaler_mcp.tools.zins.web_traffic import zins_get_web_protocols
        ...
        mock_client = MagicMock()
        mock_client.zins.web_traffic.get_protocols.return_value = (
    ...
    def test_get_threat_super_categories_success(self, mock_get_client):
        ...
        mock_client = MagicMock()
        mock_client.zins.web_traffic.get_threat_super_categories.return_value = (
            [mock_entry],
            None,
            None,
        )
        ...
        result = zins_get_threat_super_categories(
            start_time=1702600000000,
            end_time=1702686400000,
            traffic_unit="TRANSACTIONS",
        )
    ...
    def test_get_threat_class_success(self, mock_get_client):
        ...
        from zscaler_mcp.tools.zins.web_traffic import zins_get_threat_class

        mock_entry = MagicMock()
        mock_entry.as_dict.return_value = {"name": "Advanced", "total": 100}

        mock_client = MagicMock()
        mock_client.zins.web_traffic.get_threat_class.return_value = (
            [mock_entry],
            None,
            None,
        )
    ...
    def test_get_web_traffic_no_grouping_with_filters(self, mock_get_client):
        ...
        mock_client = MagicMock()
        mock_client.zins.web_traffic.get_no_grouping.return_value = (
            [mock_entry],
            None,
            None,
        )
        ...
        result = zins_get_web_traffic_no_grouping(
            start_time=1702600000000,
            end_time=1702686400000,
            traffic_unit="TRANSACTIONS",
        ...
        mock_client.zins.web_traffic.get_no_grouping.assert_called_once()
        call_kwargs = mock_client.zins.web_traffic.get_no_grouping.call_args[1]
        assert call_kwargs["dlp_engine_filter"] == "HIPAA"
        assert call_kwargs["action_filter"] == "BLOCK"


class TestZINSServiceRegistration:
    """Tests for Z-Insights service registration."""

    def test_zins_service_exists_in_registry(self):
        """Test that zins service is registered."""
        from zscaler_mcp.services import get_available_services, get_service_names

        service_names = get_service_names()
        assert "zins" in service_names

        services = get_available_services()
        assert "zins" in services
    ...
    def test_zins_service_tool_names(self):

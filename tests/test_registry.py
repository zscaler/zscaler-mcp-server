...
class TestRegistry(unittest.TestCase):
    ...
    def test_get_service_names(self):
        ...
        expected_services = {"zcc", "zdx", "zpa", "zia", "zid", "ztw", "zeasm", "zins", "zms"}
        self.assertEqual(set(service_names), expected_services)
        self.assertEqual(len(service_names), 9)
    ...
    def test_service_registry_immutability(self):
        ...
        self.assertEqual(len(available_services_2), 9)  # Should still have 9 services

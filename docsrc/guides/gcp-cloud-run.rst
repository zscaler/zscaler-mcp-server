...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/gcp_cloud_run.png
   :alt: Video: Zscaler MCP Server and Google Cloud Run
   :target: https://zscaler.wistia.com/medias/ns3qmngu25
   :align: center
   :width: 640px

▶ **Walkthrough:** `Zscaler MCP Server and Google Cloud Run (Wistia) <https://zscaler.wistia.com/medias/ns3qmngu25>`__

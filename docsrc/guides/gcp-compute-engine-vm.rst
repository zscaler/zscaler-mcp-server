...
.. note::
   ...
   Compute Engine VM has no dedicated video walkthrough yet — see the `complete GCP walkthrough <https://zscaler.wistia.com/medias/13jxjizk3r>`__ on Wistia for full coverage of every GCP target including this one.

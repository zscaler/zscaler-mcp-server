...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/gcp_gke.png
   :alt: Video: Zscaler MCP Server and Google GKE
   :target: https://zscaler.wistia.com/medias/n6w0uy6v8o
   :align: center
   :width: 640px

▶ **Walkthrough:** `Zscaler MCP Server and Google GKE (Wistia) <https://zscaler.wistia.com/medias/n6w0uy6v8o>`__

.. _guide-azure-ai-foundry:

Azure AI Foundry Agent
======================

This guide covers integrating the Zscaler MCP Server with `Azure AI Foundry <https://ai.azure.com>`__ to create autonomous security agents powered by GPT-4o (or GPT-4) that can call 300+ Zscaler tools.
...
.. list-table::
   ...
   * - Method
     ...
     - Best For
   * - **API (CLI)**
     - Create and manage the agent via ``azure_mcp_operations.py`` commands
...
.. image:: /_static/img/azure-ai-foundry.png
   :alt: Azure AI Foundry agent architecture — GPT-4o reasoning, MCPTool binding, Container Apps / VM / AKS hosting, Key Vault secret storage, and the OneAPI path to the Zero Trust Exchange
   :align: center
...
2. **An Azure AI Foundry project** — See `Creating a Foundry Project`_ below.
...
Go to `ai.azure.com <https://ai.azure.com>`__. You'll see the Foundry home page with your recent projects (if any).

.. image:: /_static/img/foundry/foundry-01-home.png
   :alt: Foundry Home
   :align: center
...
.. image:: /_static/img/foundry/foundry-02-create-project.png
   :alt: Create Project
   :align: center
...
.. image:: /_static/img/foundry/foundry-03-creating.png
...
.. image:: /_static/img/foundry/foundry-04-ready.png
   :alt: Project Ready
   :align: center
...
.. image:: /_static/img/foundry/foundry-05-endpoint.png
   :alt: Project Endpoint
   :align: center
...
.. image:: /_static/img/foundry/foundry-06-agent-created.png
   :alt: Agent Created
   :align: center
...
You can also configure the Foundry agent through the Azure AI Foundry portal at `ai.azure.com <https://ai.azure.com>`__.
...
1. Go to `ai.azure.com <https://ai.azure.com>`__
2. Open your project
...
.. list-table::
   ...
   * - ``python azure_mcp_operations.py agent_chat -m "query"``
     - Send a single query
   * - ``python azure_mcp_operations.py agent_status``
     - Show agent status
   * - ``python azure_mcp_operations.py agent_destroy``
...
.. list-table::
   ...
   * - ``ZSCALER_CLOUD``
     - Yes
     - Zscaler cloud (e.g., ``beta``, ``production``)

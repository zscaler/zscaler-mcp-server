...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/azure_complete.png
   :alt: Video: Zscaler Integration MCP Server in Azure — complete
...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/azure_container_apps.png
   :alt: Video: Zscaler MCP Server and Azure Container Apps
   :target: https://zscaler.wistia.com/medias/4ddig7h580
   :align: center
   :width: 640px

▶ **Walkthrough:** `Zscaler MCP Server and Azure Container Apps (Wistia) <https://zscaler.wistia.com/medias/4ddig7h580>`__
...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/azure_container_vms.png
   :alt: Video: Zscaler MCP Server and Azure VM
   :target: https://zscaler.wistia.com/medias/7zz9cvhga2
   :align: center
   :width: 640px

▶ **Walkthrough:** `Zscaler MCP Server and Azure VM (Wistia) <https://zscaler.wistia.com/medias/7zz9cvhga2>`__
...
.. image:: https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/azure_container_aks.png
   :alt: Video: Zscaler MCP Server and Azure Kubernetes Service
   :target: https://zscaler.wistia.com/medias/yxd5k8hzh3
   :align: center
   :width: 640px

▶ **Walkthrough:** `Zscaler MCP Server and Azure Kubernetes Service (Wistia) <https://zscaler.wistia.com/medias/yxd5k8hzh3>`__

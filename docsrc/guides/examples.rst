...
* "Show me all blocked traffic across ZIA and ZPA"
* "List all security alerts from ZDX and ZIA"
* "Get a comprehensive security overview for our organization"
* "Show me all users with elevated privileges across all services"

**Compliance and Auditing:**

* "Generate a compliance report for all Zscaler services"
* "Show me all configuration changes made in the last 30 days"
* "List all admin activities across ZIA, ZPA, and ZTW"
* "Get audit logs for all services for compliance review"

**Performance Monitoring:**

* "Show me performance metrics across all applications"
* "List all devices with performance issues"
* "Get network performance statistics for all locations"
* "Show me application response times across all services"

**User Experience:**

* "Show me user experience scores across all applications"
* "List all users experiencing connectivity issues"
* "Get user activity reports across all services"
* "Show me application usage patterns for different departments"

**Troubleshooting:**

* "Help me troubleshoot connectivity issues for user john.doe"
* "Show me all alerts and issues across all services"
* "Get detailed logs for troubleshooting network problems"
* "Show me device status and health across all platforms"

**Configuration Management:**

* "Show me all pending configuration changes across services"
* "List all policies that need to be updated"
* "Get configuration status for all Zscaler services"
* "Show me all rules and policies for review"

**Reporting and Analytics:**

* "Generate a monthly security report for all services"
* "Show me usage statistics across all applications"
* "Get performance analytics for all network services"
* "Create a comprehensive dashboard of all Zscaler metrics"

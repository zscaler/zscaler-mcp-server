...
<!--
  ...
  Source of truth: integrations/claude-code-plugin/README.md
...
- [Authentication & Deployment Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md)

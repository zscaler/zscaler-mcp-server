...
<!--
  ...
  Source of truth: integrations/github/README.md
...
| File | Purpose |
|------|---------|
| [`server.json`](https://github.com/zscaler/zscaler-mcp-server/blob/master/server.json) | MCP Registry manifest — server metadata, packages, and required environment variables |
| [`README.md`](https://github.com/zscaler/zscaler-mcp-server/blob/master/README.md) | Contains `<!-- mcp-name: ... -->` HTML comment for PyPI ownership proof |
| [`Dockerfile`](https://github.com/zscaler/zscaler-mcp-server/blob/master/Dockerfile) | Contains `LABEL io.modelcontextprotocol.server.name=...` for Docker image ownership proof |
...
The full set of security env vars (TLS, auth, host validation) is for HTTP/SSE deployments and is documented in the main [README](https://github.com/zscaler/zscaler-mcp-server/blob/master/README.md).
...
For detailed publication steps, ownership proof requirements, and troubleshooting, see [`local_dev/GitHub/mcp-registry-publication.md`](https://github.com/zscaler/zscaler-mcp-server/blob/master/local_dev/GitHub/mcp-registry-publication.md).

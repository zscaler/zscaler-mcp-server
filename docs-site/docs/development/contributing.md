...
:::warning Preview release — external contributions paused
...
If you would like to report a bug, request a feature, or share feedback during the preview, please open an issue on [GitHub Issues](https://github.com/zscaler/zscaler-mcp-server/issues) or start a thread in [GitHub Discussions](https://github.com/zscaler/zscaler-mcp-server/discussions). We read every one.
...
See the full [`CONTRIBUTING.md`](https://github.com/zscaler/zscaler-mcp-server/blob/master/CONTRIBUTING.md) on GitHub for the canonical guide.
...
This project uses [Conventional Commits](https://www.conventionalcommits.org/) for automated releases and semantic versioning. Format your commit messages as:
...
See [Building from source](./building-from-source) for the full dev environment setup.

## Code of conduct

Please read our [Code of Conduct](https://github.com/zscaler/zscaler-mcp-server/blob/master/CODE_OF_CONDUCT.md) before contributing.

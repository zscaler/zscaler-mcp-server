...
<!--
  ...
  Source of truth: integrations/google/README.md
...
[![Video: Zscaler Integration MCP Server in GCP — complete walkthrough](https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/gcp_complete.png)](https://zscaler.wistia.com/medias/13jxjizk3r)
...
| Cloud Run | GKE |
|:---------:|:---:|
| [![Video: Zscaler MCP Server and Google Cloud Run](https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/gcp_cloud_run.png)](https://zscaler.wistia.com/medias/ns3qmngu25) | [![Video: Zscaler MCP Server and Google GKE](https://raw.githubusercontent.com/zscaler/zscaler-mcp-server/master/assets/gcp_gke.png)](https://zscaler.wistia.com/medias/n6w0uy6v8o) |
...
See [adk/README.md](/docs/integrations/google-adk) for full documentation.

### Option 3: Gemini CLI Extension

The Zscaler MCP Server is also available as a Gemini CLI extension for local developer use. The extension manifest (`gemini-extension.json`) lives at the repository root (required by Gemini CLI) and is documented in [integrations/gemini-extension/README.md](/docs/integrations/gemini-cli).
...
- [GCP Secret Manager Integration](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/gcp_secrets_manager_integration.md)
- [Cloud Run Deployment Guide](https://zscaler.github.io/zscaler-mcp-server/docs/deployment/gcp)
- [Main README](https://github.com/zscaler/zscaler-mcp-server/blob/master/README.md)
- [Supported Tools Reference](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/supported-tools.md)
- [Troubleshooting](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md)

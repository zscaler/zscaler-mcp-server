...
- [PR #44](https://github.com/zscaler/zscaler-mcp-server/pull/44) - Created comprehensive [GCP Cloud Run Deployment Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/gcp_secrets_manager_integration.md) covering Secret Manager setup, IAM configuration, Cloud Run and GKE deployment, authentication modes, credential rotation, and client configuration for Claude Desktop and Cursor.
...
- [PR #37](https://github.com/zscaler/zscaler-mcp-server/pull/37) - Created comprehensive [Authentication & Deployment Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md) covering:

...
**Full details:** [Authentication & Deployment Guide — Remote Deployment](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md#remote-deployment-ec2-vm-etc) and [421 Misdirected Request](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md#421-misdirected-request-invalid-host-header)

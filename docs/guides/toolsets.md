...
| `zpa_segment_groups` | yes | 6 | ZPA segment groups (CRUD): zpa_list_segment_groups, zpa_get_segment_group, zpa_create_segment_group, zpa_update_segment_group, zpa_delete_segment_group. Referenced by application segments via segment_group_id and by access policy rules as the APP_GROUP operand. |

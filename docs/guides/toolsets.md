...
| `zpa_service_edge_groups` | yes | 5 | ZPA service edge groups (CRUD): zpa_list_service_edge_groups, zpa_get_service_edge_group, zpa_create_service_edge_group, zpa_update_service_edge_group, zpa_delete_service_edge_group. Cloud-hosted alternatives to on-prem app connectors. |
